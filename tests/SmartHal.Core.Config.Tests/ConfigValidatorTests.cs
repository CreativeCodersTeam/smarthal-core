...
public sealed class ConfigValidatorTests : IDisposable
{
    ...
    private readonly YamlConfigWriter _writer = new YamlConfigWriter(NullLogger<YamlConfigWriter>.Instance);
    ...
    {
        // Arrange
        var validator = new ConfigValidator(_reader, NullLogger<ConfigValidator>.Instance);
